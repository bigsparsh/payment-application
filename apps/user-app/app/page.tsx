  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-stone-500 md:text-xl dark:text-stone-400">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-stone-100 dark:bg-stone-800">
          <div className="container px-4 md:px-6">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            ...
            <div className="grid gap-4">
              <div className="flex flex-col bg-stone-100 dark:bg-stone-950 rounded-lg p-6 space-y-4">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 border-t">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-stone-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-stone-400">
